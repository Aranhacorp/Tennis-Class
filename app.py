...
# Corrigido para garantir que a imagem apareça sobre o fundo
st.markdown("""
    <style>
    .stApp {
...
if menu == "Home":
    ...
    with st.container():
        ...
        # CORREÇÃO: Bloco try/except completo para evitar erro de execução
        try:
            ...
            with st.form("agendamento"):
                ...
                if st.form_submit_button("CONFIRMAR RESERVA"):
                    if aluno:
                        ...
                        # CORREÇÃO: Fechamento de dicionário e DataFrame
            ...
            # CORREÇÃO: Aspas fechadas na string de aviso
            st.warning("Conectando ao banco de dados...")
        st.markdown('</div>', unsafe_allow_html=True)

# --- PÁGINA CADASTRO ---
elif menu == "Cadastro":
    # CORREÇÃO: Fechamento de markdown
